...
prepare_enrollments_mapping <- function(enrollments) {
  ...
  map_opleidingsfase <- read_mapping("Mapping_INS_opleidingsfase_naam.csv")
  map_actief <- read_mapping("Mapping_INS_actief_peil_omschr.csv")
  map_examen <- read_mapping("Mapping_INS_examenres_omschr.csv")
  map_eerstejaars_cat <- read_mapping("Mapping_INS_ind_ej_inst_cat.csv")
  map_eerstejaars_naam <- read_mapping("Mapping_INS_ind_ej_inst_naam.csv")
  map_eerstejaars_opl <- read_mapping("Mapping_INS_ind_ej_opl_inst_naam.csv")
  map_leeftijd <- read_mapping("Mapping_DEM_Leeftijd_cat.csv")
  map_inschrijving <- read_mapping("Mapping_INS_soort_inschr_cat.csv")
